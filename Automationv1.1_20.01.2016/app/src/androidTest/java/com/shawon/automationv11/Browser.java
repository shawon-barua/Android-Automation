...
public class Browser extends InstrumentationTestCase{
    ...
    public void setUp() throws Exception {
        ...
        device.wait(Until.hasObject(By.text("Chrome")), 3000);


        UiObject playStore = device.findObject(new UiSelector().text("Chrome"));
    ...
    public void testBrowser() throws Exception {
        ...
        UiObject url = device.findObject(new UiSelector().resourceId("com.android.chrome:id/url_bar"));
        url.clearTextField();
        device.swipe(232, 107, 232, 107, 0);
        url.setText("goal.com");
        device.swipe(663, 1208, 663, 1208, 0);
