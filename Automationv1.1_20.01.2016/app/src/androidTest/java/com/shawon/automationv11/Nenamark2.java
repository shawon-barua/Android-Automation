...
public class Nenamark2 extends InstrumentationTestCase{
    ...
    public void testAntutu() throws Exception {
       ...
       // device.waitForIdle(12000);
        ...
        device.waitForIdle(4000);
        device.swipe(575, 1105, 575, 1105, 0);
        device.waitForIdle(4000);
        device.swipe(71, 999, 71, 999, 0);
        device.waitForIdle(4000);
        device.swipe(251, 890, 251, 890, 0);
        device.waitForIdle(4000);
        device.swipe(573, 997, 573, 997, 0);
        device.waitForIdle(4000);
        ...
        UiObject antutu = device.findObject(new UiSelector().text("NenaMark2"));
